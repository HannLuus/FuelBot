...
Deno.serve(async (req) => {
  ...
  const html = buildInvoiceEmailHtml({
    ...
    thankYouMessage:
      'This is a test invoice email for layout preview. No payment action is required. If this format looks good, we will keep this style for all customer invoices.',
  })
